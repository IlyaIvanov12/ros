...
if(NOT "/home/vilgiz/ilya_homework_ws/devel/include " STREQUAL " ")
  set(glass_ladder_INCLUDE_DIRS "")
  set(_include_dirs "/home/vilgiz/ilya_homework_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'glass_ladder' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vilgiz/ilya_homework_ws/src/glass_ladder/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/vilgiz/ilya_homework_ws/devel/lib;/opt/ros/noetic/lib)
